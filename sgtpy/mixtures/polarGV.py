...
def Apolar(rho, x, T, anij, bnij, cnij, eta, eps, epsij, sigma3, sigmaij3,
           sigmaijk3,  npol, muad2):
...
def dApolar_drho(rho, x, T, anij, bnij, cnij, eta, deta, eps, epsij, sigma3,
    ...
    J2DDij, dJ2DDij = np.tensordot(etavec, anij + bnij * epsija,
                                   axes=((1), (0)))
    dJ2DDij *= deta

    J3DDijk, dJ3DDijk = np.tensordot(etavec, cnij,
                                     axes=((1), (0)))
    dJ3DDijk *= deta
...
def d2Apolar_drho(rho, x, T, anij, bnij, cnij, eta, deta, eps, epsij, sigma3,
    ...
    J3DDijk, dJ3DDijk, d2J3DDijk = np.tensordot(etavec, cnij,
                                                axes=((1), (0)))
    dJ3DDijk *= deta
    d2J3DDijk *= deta**2
...
def dApolar_dxrho(rho, x, T, anij, bnij, cnij, eta, deta, deta_dx, eps,
                  epsij, sigma3, sigmaij3, sigmaijk3,  npol, muad2):
