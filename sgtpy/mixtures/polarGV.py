...
def dApolar_drho(rho, x, T, anij, bnij, cnij,
           eta, deta, eps, epsij, sigma3, sigmaij3, sigmaijk3,  npol, muad2):
...
def d2Apolar_drho(rho, x, T, anij, bnij, cnij,
           eta, deta, eps, epsij, sigma3, sigmaij3, sigmaijk3,  npol, muad2):
    ...
    J2DDij, dJ2DDij, d2J2DDij = np.tensordot(etavec, anij + bnij * epsija, axes = ((1), (0)))
    dJ2DDij *= deta
    d2J2DDij *= deta**2
...
def dApolar_dx(rho, x, T, anij, bnij, cnij,
           eta, deta_dx, eps, epsij, sigma3, sigmaij3, sigmaijk3,  npol, muad2):
...
def dApolar_dxrho(rho, x, T, anij, bnij, cnij,
           eta, deta, deta_dx, eps, epsij, sigma3,
