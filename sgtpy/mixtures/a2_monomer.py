...
#Eq A20
def da2_dxhi00(xs, khs, dkhs, xhixm, dxhim_dxhi00,
               da2ij, epsij, f1, f2, f3):
...
#Eq A20
def d2a2_dxhi00(xs, khs, dkhs, d2khs, xhixm, dxhim_dxhi00, 
                d2a2ij, epsij, f1, f2, f3):
...
#Eq A20
def da2_dx(xs, dxs_dx, khs, dkhs, xhixm, dxhim_dx, a2ij, da2ijx, epsij, f1, f2, f3):
    xi = Xi(xhixm, f1, f2, f3)
...
#Eq A20
def da2_dxxhi(xs, dxs_dx, khs, dkhs, dkhsx, xhixm, dxhim_dxhi00,
              dxhim_dx, da2ij, da2ijx, epsij, f1, f2, f3):
