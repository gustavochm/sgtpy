...
def dIab_dxrho(xhi, dxhi_dxhi00, dxhi00_drho, dxhi_dx, dii, dij, rcij, rdij, sigmaij3):
...
'''
def fobj_xass(Xass, rho, DIJ, Dabij, xj):
    suma = rho * np.sum(DIJ*xj*Xass*Dabij, axis = 1)
    print(suma)
    FO = Xass + Xass*suma - 1
    return FO
'''
...
def d2Xass_drho(rhom, xj, Xass, dXass_drho, DIJ,
                Dabij, dDabij_drho, d2Dabij_drho,  CIJ):
