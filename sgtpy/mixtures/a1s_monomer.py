import numpy as np 
from .monomer_aux import xhi_eff, dxhieff_dxhi00, d2xhieff_dxhi00, d3xhieff_dxhi00
from .monomer_aux import dxhieff_dx, dxhieff_dx_dxhi00
...
def da1s_dx(xhi00, xhix, xm, ms, cictes, a1vdw, dxhix_dx):
    #a1s calculation Eq 39
    xhieff = xhi_eff(xhix, cictes) #bien
    dxhieff = dxhieff_dx(xhix, cictes, dxhix_dx) #bien
    #a1vdw = -12 * epsij * dij**3 / (lam - 3)
    
    #da1 = np.multiply.outer((-2 + xhieff) * (-1 + xhieff), ms)
...
def da1s_dx_dxhi00(xhi00, xhix, xm, ms, cictes, a1vdw,
    ...
    dxhieffdxdxhi00 = dxhieff_dx_dxhi00(xhix, cictes, dxhix_dxhi00,  dxhix_dx, dxhix_dx_dxhi00)
